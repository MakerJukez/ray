  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#070B15] text-white">
      ...
      <header className="px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-8">
          ...
          <nav className="md:flex items-center gap-6 text-md hidden md:visible text-slate-500 pl-5">
            ...
            <a href="https://t.me/raydadog" className="">
              Telegram
            </a>
          ...
          <div className="relative bg-[#1E243C] rounded-xl p-6 space-y-4">
            ...
            <div className='w-full bg-[#151A2E] rounded-lg'>
              ...
              <div className='w-full flex justify-between p-2 bg-[#070B15] rounded-lg'>
                <div className='text-2xl md:text-3xl'>
                  <div className='p-2 bg-[#1E243C] rounded-lg flex justify-center items-center gap-2'>
                    <img src="ra.png" alt="Raydium" className="size-8 rounded-full border-2 border-[#2d334e]" />
                      RAY
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                      <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                    </svg>
      ...
      <div className='w-screen flex justify-between py-4 px-8 bg-[#1E243C] text-sm md:hidden text-slate-500'>
        ...
        <a href="https://x.com/raydadog" className='md:hover:text-sky-200 transition ease-in-out duration-150'>
          <div className='flex justify-center'>
        ...
        <a href="https://t.me/raydadog" className='md:hover:text-sky-200 transition ease-in-out duration-150'>
          <div className='flex justify-center'>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className='size-6' fill="currentColor" viewBox="0 0 50 50">
